...
class ClientTypeRequest extends Request
{
    ...
    {
        return [
            'code'                      => 'required|max:2|unique:client_types,code,'.$this->clientTypeId.',id,deleted_at,NULL',
            'description'               => 'required|max:40|unique:client_types,description,'.$this->clientTypeId.',id,deleted_at,NULL'
        ];
    }
