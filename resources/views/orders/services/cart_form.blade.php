      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-left">R$ {{ number_format(($service->sale_value * $factor), 2,",",".") }}</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
      ...
      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <div class="input-group input-group-sm">
          ...
          {!! Form::text('discount', $value = '0,00', ['id'=>'discount', 'class'=>'form-control']) !!}
        </div>
      </div>
    </div>

    <div class="form-group {{ $errors->has('service_qty') ? 'has-error' : '' }}">
      <label for="service_qty" class="col-xs-12 col-sm-2 col-md-2 col-lg-3 control-label">Qte:</label>
      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <div class="input-group input-group-sm">
          <span class="input-group-addon"><i class="fa fa-money"></i></span>
          {!! Form::text('service_qty', $value = '1,00', ['id'=>'service_qty', 'class'=>'form-control']) !!}
        </div>
      </div>
    </div>
  </div>
...
@section('js_scripts')
  <script type="text/javascript">
      $("#discount, #service_qty").priceFormat(
      {
        prefix: '',
        centsSeparator: ',', 
        thousandsSeparator: '.',
