<div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-3 col-md-3 col-lg-2">
		<div class="input-group input-group-sm">
			...
			{!! Form::text('code', $value = null, ['class'=>'form-control', 'autofocus'=>'autofocus', 'maxlength'=>'10']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('unit') ? 'has-error' : '' }}">
	<label for="unit" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Unidade:</label>
	<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::text('unit', $value = null, ['class'=>'form-control', 'maxlength'=>'3']) !!}
		</div>
	</div>
</div>
...
@section('js_scripts')
	<script type="text/javascript">
	  	$("#cost_value, #sale_value").priceFormat(
  		{
 			prefix: '',
		    centsSeparator: ',', 
		    thousandsSeparator: '.',
